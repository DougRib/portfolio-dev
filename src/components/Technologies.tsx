...
const techGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Flask', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/flask/flask-original.svg', docs: 'https://flask.palletsprojects.com/en/latest/' },
    ],
  },
  {
    id: 'database',
            ...
            >
              {group.items.map((tech) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.96 }}
                >
                  <div className="relative w-24 h-24 sm:w-20 sm:h-20 md:w-30 md:h-30 p-3 sm:p-2  rounded-xl flex items-center justify-center bg-black/40 backdrop-blur-sm border border-blue-500/20 shadow-[0_0_10px_rgba(59,130,246,0.08)] group-hover:shadow-[0_0_30px_rgba(59,130,246,0.4)] transition-all duration-300">
