          ...
          {project.caseStudy && (
            <div className="mt-4 text-sm text-gray-300 space-y-3">
              {project.caseStudy.problem && (
                <div>
                  <div className="text-xs text-blue-400 font-semibold">Problema</div>
                  <div className="text-muted-foreground">{project.caseStudy.problem}</div>
                </div>
              )}
              {project.caseStudy.solution && (
                <div>
                  <div className="text-xs text-blue-400 font-semibold">Solução</div>
                  <div className="text-muted-foreground">{project.caseStudy.solution}</div>
                </div>
              )}
              {project.caseStudy.result && (
                <div>
                  <div className="text-xs text-blue-400 font-semibold">Resultado</div>
