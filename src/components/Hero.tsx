    ...
    <section className="relative min-h-screen w-full flex items-center justify-center overflow-hidden pt-36">
      <div className="container mx-auto px-6 z-10 relative">
        <div className="max-w-6xl mx-auto text-center px-4">
          ...
          >
            <span className="block">Olá, eu sou Kalp Senghani</span>
            <span className="block mt-2">
              <span className="bg-[radial-gradient(ellipse_at_right,_var(--tw-gradient-stops))] from-indigo-500 via-red-500 to-blue-500 text-transparent bg-clip-text">Desenvolvedor Full Stack</span> <span className="text-white">criando<br className="hidden sm:block" /> soluções escaláveis, orientadas a dados e confiáveis <br className="hidden sm:block" /> </span><span className="bg-gradient-to-r from-red-500 via-green-500 to-purple-500 text-transparent bg-clip-text">em software.</span>
            </span>
          </motion.h1>
